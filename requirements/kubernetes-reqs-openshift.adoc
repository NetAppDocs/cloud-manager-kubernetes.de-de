...
Kubernetes-Konfigurationsdatei (kubeconfig) mit RBAC-Autorisierung:: Zum Importieren von OpenShift-Clustern benötigen Sie eine kubeconfig-Datei mit der RBAC-Berechtigung, die erforderlich ist, um verschiedene Funktionen zu ermöglichen.  a kubeconfig file.
+
--
